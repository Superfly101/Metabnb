    ...
    >
      ...
      <section className="bg-white py-4 rounded-xl w-full max-w-[30rem]">
        <div className="relative mb-4 px-6">
          ...
          <button className="absolute top-0 right-6" onClick={onCloseHandler}>
        ...
        <div className="py-2 px-6 border-t flex flex-col gap-3">
          ...
          <div className="border relative rounded-lg p-3 flex gap-4 items-center cursor-pointer hover:bg-[#F8F9FA]">
            <img
              ...
              alt="Metamask icon"
            />
            <p className="font-semibold">WalletCoin</p>
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
