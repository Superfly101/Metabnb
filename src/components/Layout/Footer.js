const Footer = () => {
  return (
    <footer className="relative pt-12 pb-16 px-4 bg-[#1D1D1E] flex text-white grid grid-cols-2 gap-8 lg:grid-cols-4 md:px-16">
      <section className="flex flex-col gap-16">
        <div className="w-40">
          <img className="w-full" src="/assets/logo1.png" alt="Metabnb logo" />
        </div>
      ...
      <section className="flex flex-col gap-4 text-sm">
        <h4 className="text-lg font-bold">Places</h4>
        <a className="w-fit" href="/">
          Castle
        </a>
        <a className="w-fit" href="/">
      ...
      <small className="absolute left-4 bottom-6 md:left-16">
        &copy; 2022 Metabnb
      </small>
    </footer>
  );
